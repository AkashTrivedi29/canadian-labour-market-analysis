...
```bash
# Clone the repo
git clone https://github.com/akash-trivedi/canadian-labour-market-analysis
...
This project was built as part of a focused **Canadian Data Analyst Portfolio Sprint** — 7 projects in 7 days designed to demonstrate production-ready data skills aligned with Canadian employer expectations (SQL, Python, Power BI/Tableau, storytelling, business context).

**Target roles:** Junior Data Analyst · Reporting Analyst · Data Quality Analyst
**NOC Code:** 21223 — Data Analyst (TEER 2 — eligible for CEC)
